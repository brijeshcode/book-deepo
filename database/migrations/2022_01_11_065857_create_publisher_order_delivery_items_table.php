...
class CreatePublisherOrderDeliveryItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('publisher_order_delivery_items', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('publisher_order_delivery_id');
    ...
    {
        Schema::dropIfExists('publisher_order_delivery_items');
    }
}
