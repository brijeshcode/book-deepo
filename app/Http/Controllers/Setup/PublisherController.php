...
class PublisherController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('publishers.index'))->with('type', 'success')->with('message', 'Publisher added successfully !!');
    }
    ...
    public function update(Request $request, Publisher $publisher)
    {
        ...
        return redirect(route('publishers.index'))->with('type', 'success')->with('message', 'Publisher updated successfully !!');
    }
