    ...
    <app-layout title="Warehouses">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        <Link :href="route('warehouses.create')" class="mb-6 bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:mx-auto">Create</Link>
                    </div>
                        ...
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                          <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                              ...
                              <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="warehouse in warehouses.data" :key="warehouse.id">
                                  ...
                                  <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <Link :href="route('warehouses.edit', warehouse.id)" class="text-indigo-600 hover:text-indigo-900">Edit</Link>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                            <Pagination
                              ...
                              :previous="warehouses.prev_page_url"
                              :next="warehouses.next_page_url"
                            />
                          </div>
                        </div>
                      </div>
