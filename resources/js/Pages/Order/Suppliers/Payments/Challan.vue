<template>
    <app-layout title="Suppliers Challan Payment">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Suppliers Challan Payment <span v-if="edit">Edit</span> <span v-else>Generate</span>
            </h2>
        </template>

        <template #breadcrum>
             <bread-simple :items="[  { route: 'suppliers.index'}, {name:'Challan'} , { name:'payment'} ]" />
...
<script>
    ...
    export default defineComponent({
        ...
        created(){
            this.form.supplier_id = this.challan.supplier_id;
