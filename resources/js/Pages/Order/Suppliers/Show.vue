<template>
    <app-layout title="Supplier Order Details">
        <template #header>
        ...
        <template #breadcrum>
            <bread-simple :items="[ {route: 'supplier.order.index'} ,  {route: 'supplier.order.index', name:'Orders'}, { name:'Details'} ]" />
        </template>
            ...
            <div class="p-2">
                ...
                <div class="flex flex-row w-full justify-between border-b">
                    ...
                    <div class="flex-col text-right px-4 py-2">
                        ...
                        <p class="text-lg font-bold text-gray-800">{{ order.supplier.name }}</p>
                        <p class="text-gray-500">{{ order.supplier.email }}</p>
                        <p class="text-gray-500">{{ order.supplier.mobile }}</p>
                    </div>
                </div>
