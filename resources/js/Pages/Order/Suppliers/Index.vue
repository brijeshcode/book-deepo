    ...
    <app-layout title="Supplier Orders">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" breadcrum flex items-center py-4 overflow-y-auto whitespace-nowrap">
                ...
                <Link :href="route('supplierOrder')"  class="text-blue-600 dark:text-blue-200 hover:underline">Orders</Link>
            </div>
        </div>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        <Link :href="route('suppliers')" class="mb-6 p-2 shadow-xl bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:mx-auto">Suppliers</Link>
                        &nbsp;
                        <Link :href="route('supplierOrder.create')" class="mb-6 p-2  bg-green-400 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:mx-auto">Generate Order</Link>
                    </div>
