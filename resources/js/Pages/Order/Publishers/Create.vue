    ...
    <app-layout title="Publishers Order">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Publishers Order <span v-if="edit">Edit</span> <span v-else>Create</span>
            </h2>
        </template>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" breadcrum flex items-center py-4 overflow-y-auto whitespace-nowrap">
                ...
                <Link :href="route('publishers')"  class="text-gray-600 dark:text-gray-200 hover:underline">Publishers</Link>
                ...
                <Link :href="route('publishersOrder')"  class="text-gray-600 dark:text-gray-200 hover:underline">Orders</Link>
                ...
                <Link :href="route('books.create')" v-else  class="text-blue-600 dark:text-blue-400 hover:underline">Create</Link>
            </div>
        </div>
