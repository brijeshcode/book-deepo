    ...
    <app-layout title="Publisher Order">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" breadcrum flex items-center py-4 overflow-y-auto whitespace-nowrap">
                ...
                <Link :href="route('publishersOrder')"  class="text-blue-600 dark:text-blue-200 hover:underline">Orders</Link>
            </div>
        </div>
                              ...
                              <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="order in orders.data" :key="order.id">
                                  ...
                                  <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <Link :href="route('publishersOrder.edit', order.id)" class="text-indigo-600 hover:text-indigo-900">Edit</Link>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
