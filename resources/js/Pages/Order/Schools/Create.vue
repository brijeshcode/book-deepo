    ...
    <app-layout title="School Order">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" breadcrum flex items-center py-4 overflow-y-auto whitespace-nowrap">
                ...
                <Link :href="route('schools')"  class="text-gray-600 dark:text-gray-200 hover:underline">Schools</Link>
                ...
                <Link :href="route('schoolOrder')"  class="text-gray-600 dark:text-gray-200 hover:underline">Orders</Link>
                ...
                <Link :href="route('schoolOrder.create')" v-else  class="text-blue-600 dark:text-blue-400 hover:underline">Create</Link>
            </div>
        </div>
